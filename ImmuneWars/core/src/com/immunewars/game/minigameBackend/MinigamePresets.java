...
public abstract class MinigamePresets {
	...
	public abstract static class SpaceInvaders {
		public static int xLowerBound = 220;
		public static int xUpperBound = 1100;
		public static int yLowerBound = 0;
		public static int yUpperBound = 800;
	...
	public abstract static class Snake {
		...
		public final static int PIXEL_SIZE = 30;
	...
	{ //when x bound 1280, the limit is 21 letters
		...
		public static final String[] wordDefinitions = {
			...
			"Large molecules composed of amino acids which perform a variety of functions in living organisms, including providing structure and\n catalyzing chemical reactions.",
			...
			"Large molecules composed of amino acids which perform a variety of functions in living organisms, including providing structure, regulating\n cellular processes, and catalyzing biochemical reactions.",
			...
			"A molecule that triggers an immune response in the body, typically by being recognized as foreign. Antigens can be proteins, carbohydrates, or other \nmolecules present on the surface of pathogens or foreign substances.",
			"Proteins produced by the immune system in response to the presence of specific antigens. Antibodies bind to antigens and mark them for destruction by \nother immune cells. They play a crucial role in the body's defense against pathogens and in the immune response to infections.",
			"The body's defense system against infectious agents, toxins, and other foreign substances. It includes various organs, cells, and molecules that work\n together to recognize and eliminate pathogens while distinguishing them from the body's own cells.",
			"The ability of an organism to resist or prevent infection and disease through the action of the immune system.",
			"The nonspecific defense mechanisms that act as the first line of defense against pathogens, including physical barriers, phagocytic cells, and\n inflammation. Innate immunity provides immediate protection but lacks specificity.",
			"The specific immune response that develops after exposure to a pathogen and provides long-term protection. It involves the activation of lymphocytes\n (T cells and B cells) and the production of antibodies.",
			...
			"A localized response to tissue injury or infection characterized by redness, swelling, heat, and pain. Inflammation helps to eliminate pathogens and\n initiate tissue repair.",
			...
			"A group of proteins in the blood that work together to enhance the immune response against pathogens. Complement proteins can directly kill pathogens\n opsonize them for phagocytosis, and stimulate inflammation.",
			"A condition in which the immune system mistakenly attacks the body's own tissues, leading to inflammation and tissue damage. Examples include rheumatoid\n arthritis, lupus, and multiple sclerosis.",
			"An exaggerated immune response to a harmless substance (allergen) that triggers inflammation and other symptoms, such as itching, sneezing, and \nswelling.",
			"A condition in which the immune system is impaired or weakened, making individuals more susceptible to infections. It can be congenital or acquired\n as seen in HIV/AIDS.",
			"A chemical released by mast cells and basophils during an allergic reaction or inflammation. Histamine causes blood vessels to dilate and become \nmore permeable, leading to the characteristic symptoms of allergy.",
			"The aspect of the adaptive immune response mediated by antibodies, which circulate in the blood and lymphatic system, neutralizing pathogens and \nmarking them for destruction.",
			"Proteins produced by cells in response to viral infections or other stimuli. Interferons play a key role in activating immune cells and inhibiting\n viral replication.",
			"A type of cytotoxic lymphocyte that plays a critical role in the innate immune response against infected or cancerous cells. NK cells can directly\n kill target cells without prior sensitization.",
			...
			"Long-lived B cells that remain in the body after an infection has resolved, providing rapid and robust antibody responses upon re-exposure to \nthe same pathogen.",
			...
			"A group of white blood cells characterized by the presence of granules in their cytoplasm. Granulocytes include neutrophils, eosinophils, and \nbasophils, which play roles in inflammation, allergic reactions, and defense against pathogens.",
			"Cells found in connective tissues that release histamine and other inflammatory mediators in response to allergens or pathogens, contributing \nto allergic reactions and inflammation.",
			"Antigen-presenting cells that capture, process, and present antigens to T cells, initiating adaptive immune responses.",
			"A vesicle formed by the engulfment of a particle, such as a bacterium or virus, by a phagocytic cell. Phagosomes fuse with lysosomes to form \nphagolysosomes, where the engulfed particle is degraded.",
			...
			"The suppression or weakening of the immune system, either naturally or as a result of medical treatment, to prevent rejection of transplanted\n organs or to treat autoimmune diseases.",

...
public class SpaceInvaders {
	ArrayList<SIElement> elements;
	
	protected void addElement(SIElement element) {elements.add(element);}
	protected void removeElement(SIElement element) {elements.remove(element);}
	
	public void addAct() {return elements;}
}
*/
